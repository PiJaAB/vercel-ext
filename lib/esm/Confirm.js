...
function omitEscapeSequence(inputStream) {
    return new Promise((resolve, reject) => {
        ...
        function onReadable() {
            ...
            const match = string.match(ansiRegex({ onlyFirst: true }));
            let offset = 0;
            let ret = false;
...
export default function Confirm(prompt, defaultResponse = null, timeout = null, outputStream = process.stderr, inputStream = process.stdin) {
